...
$query_user = mysqli_query($conn, "SELECT * FROM user WHERE user_id = $user_id LIMIT 1");

$query_postingan = mysqli_query($conn, "SELECT * FROM foto WHERE user_id = $user_id ORDER BY user_id ASC");
...
<nav>
  ...
  <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z"/>
          ...
          <li>
            <a href="./register.php"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
